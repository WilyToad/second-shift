...
Planned at the player's request (2026-09-15) from the throughput decision: no second Factorio instance and no custom simulator, so the estimates get better and the exact numbers come from the player's own game. The in-game panel (FC-060) stays in the backlog: the player left it out of this sprint.
