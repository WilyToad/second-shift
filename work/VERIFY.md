...
| 5 | ✅ 18 Sep — held, then sent at the 6 s cap ("What's the best way to get my", 9.3 s clip); the resume-within-6-s path not exercised | Say "…what's the best way to get my" and pause | It waits; finish the sentence | One question, not two | FC-173 |
