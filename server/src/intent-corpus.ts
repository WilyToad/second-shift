// The intent corpus (FC-199): every classifier, and every real question they were built from, in one place so the
// unit test and the FC-245 benchmark score the same rows.
 ...
 */
export const CLASSIFIERS: Record<string, (q: string) => boolean> = {
...
export const CORPUS: [question: string, expected: string[]][] = [
  ["where am I?", []],
